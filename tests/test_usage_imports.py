...
def test_usage_import_is_side_effect_free_and_provider_neutral() -> None:
    statement = "\n".join(
        [
            ...
            "assert usage.UsageRepository",
            "assert usage.LocalJSONUsageRepository",
            "assert usage.UsageRepositoryError",
            "assert usage.UsageSummary",
            "assert usage.UsageAggregator",
            "assert usage.DefaultUsageAggregator",
            "assert usage.UsageAggregationError",
